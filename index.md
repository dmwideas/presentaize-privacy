...
## 2. Important: User-Entered Content
...
|------|-----------|-----------------|
| Feedback | 24 hours | **Firestore TTL** |
| Gemini AI | Never stored | — |
| Usage Data | 30 days | Automatic |
| Support emails | Only during resolution | Manual |

---

## 4. International Transfer

Data processed in **Spain**.  
Transferred to **Google (EU/US)** under:
...
- **Access / Delete**: Email **dmwideas@gmail.com**
- **Response**: Within **30 days**
- **Automatic deletion**: Feedback in 24h
